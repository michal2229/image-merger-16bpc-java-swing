 ...
 */
public class TylkoJasniejsze extends Przetwarzanie{
    public TylkoJasniejsze(List<String> fileName, String directoryName) throws IOException{
    ...
    public Void doInBackground() throws IOException{// ilosc wszystkich plikow
        System.out.println("Przetwarzanie: tylko jaśniejsze..."); // info
        liczenieTylkoJasniejszych(tablicaRobocza, rasterDoZapisu); 
        ...
        zapisywanie("tylko_jasniejsze", rasterDoZapisu); // zapis pliku
        return null;
    }
    
    public void liczenieTylkoJasniejszych(int[][][] temp, WritableRaster destination) throws IOException{
    ...
    } // tu liczony jest obraz bedacy maksimum odpowiadajacych pikseli z wybranych obrazow
}
